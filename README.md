# NeuroWatch OS v0.5 — Cyber Terminal (Watchy V2)
...
Отсутствуют: ИИ на самих часах, голос, синхронизация с iPhone, автономные уведомления и проверенный откат при неудачном обновлении. Их нельзя обещать как готовые функции v0.5.

## Сборка на GitHub с iPhone

1. Открыть [GitHub Actions](https://github.com/Azotishka/shiny-invention/actions), выбрать **NeuroWatch v0.5 Watchy V2**, дождаться зелёной отметки.
...
python scripts/inspect_factory_partitions.py watchy_factory_4mb.bin --image NeuroWatch-OS-v0.5-Watchy-V2-UNVERIFIED-APP.bin
```
